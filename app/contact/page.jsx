        ...
        <div className = "flex flex-col xl:flex-row gap-[30px]">
            ...
            <div className = "xl:w-[54%] order-2 xl:order-none">
                <form className = "flex flex-col gap-6 p-10 bg-[#27272c] rounded-xl" ref = {form} onSubmit ={sendEmail}>
                    ...
                    <p className ="text-white/60">Hello! I want to kickstart my career as a Software Development Engineer. I am fresh out of school. I want to learn and grow in my career while contributing to your team's success. Let's collaborate and achieve great things together!</p>
                    {/* input */}
